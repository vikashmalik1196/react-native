      ...
      <CustomLabel label="SIGN UP" />
        <View style={{ backgroundColor: "white", height: "100%", marginTop: 100,marginBottom:0, borderRadius: 30 }}>
          ...
          <View style={{ marginTop: 20 }}>
            ...
            />
            <CustomLabel label="SIGN UP" />
            <CustomInput label="Name" onChangeText={value => onChangeText({ name: 'name', value })} />
            <CustomInput label="Email" onChangeText={value => onChangeText({ name: 'email', value })} />
            <CustomInput label="Phone" onChangeText={value => onChangeText({ name: 'phone', value })} />
